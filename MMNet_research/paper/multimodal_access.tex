...
$0.654$. A representative held-out night is
...
problem with this prior. The failure mode is more informative than the headline. For the two
checkpoints whose predicted stage distributions were retained, Wake takes $62$ to $67\%$ of
stroke epochs against a true $26.6\%$, while N2 falls to between $1.8$ and $4.9\%$ of
predictions on the stage that is $42.3\%$ of the data. These models do not lose accuracy
