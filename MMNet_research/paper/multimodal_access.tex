...
\newcommand{\mmAcc}{0.740}   % was 0.722 (feature-only configuration)
\newcommand{\mmMf}{0.671}    % was 0.651
\newcommand{\mmK}{0.635}     % was 0.611
\newcommand{\mmAuc}{0.782}   % was 0.711
\newcommand{\mmAp}{0.418}    % was 0.337
...
\begin{table}[t]
\caption{\stale{[STALE -- modality ablation table not yet regenerated for the final model]} Modality-ablation grid (leave-one-out), ten-fold patient-independent. Each row removes
...
The two heads answer differently. Staging accuracy rises $0.693 \rightarrow 0.714 \rightarrow
