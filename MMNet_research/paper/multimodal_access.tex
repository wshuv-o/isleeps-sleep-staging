...
brain--computer interfaces. His research centres on learning from EEG and the other
physiological signals recorded overnight. He conceived and led the present study,
designing the two-stream architecture that treats sleep staging and respiratory-event
detection as one joint problem, and implementing its concatenative fusion, its recurrent
temporal decoder, and the direct cardiorespiratory path to the respiratory head. He also
wrote the ten-fold patient-independent reproduction engine behind the reported numbers,
and ran the modality-ablation grid and the fold-level significance testing on which the
paper's causal attribution claims rest. He serves as a reviewer for several international
