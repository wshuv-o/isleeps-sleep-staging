...
\begin{figure*}[p]
\centering
% the diagram is portrait (about 5:6); at full \textwidth across two columns it
% would overrun the page, so it is fitted to the text height instead
\includegraphics[height=0.92\textheight,keepaspectratio]{figures/fig_architecture.pdf}
...
once. The two embeddings are fused and read across the night by a bidirectional LSTM. A
