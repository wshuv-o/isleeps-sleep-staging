...
%
%  Photographs: author1-3.png are in this directory; the fourth author has no
%  photograph yet. IEEE Access accepts a biography without one -- delete the
%  optional [{...}] argument if none is supplied.
%=====================================================================

\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{author1.png}}]{MD WAHIDUZZAMAN SUVA}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{author2.png}}]{ESM-E MOULA CHOWDHURY ABHA}
is with the Department of Computer Science and Engineering, American International
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{author3.png}}]{MD IMTIAJ ALAM SAJIN}
is with the Department of Computer Science and Engineering, American International
University-Bangladesh (AIUB), Dhaka, Bangladesh. His research interests include deep learning,
...
\begin{IEEEbiography}{MD IFTEKHARUL MOBIN}
