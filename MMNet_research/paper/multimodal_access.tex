...
Sleep-EDF Cassette subset used throughout this paper, $40$ recordings from $21$
subjects, single Fpz-Cz derivation. $\approx$ marks an accuracy inferred from the macro-F1 its paper
reports.}
\label{tab:reimpl}
\centering
...
as published. We trained three architectures on the Sleep-EDF Cassette subset and applied each to all
