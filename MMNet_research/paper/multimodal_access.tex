...
\textbf{The respiratory read-out transfers.} On ISRUC night one the model reaches $0.721$
...
identify.} On Sleep-EDF the model \emph{gains} $0.102$ of $\kappa$ over its in-domain
...
the lowest per-class F1 in-domain).

Comparing the two also isolates the montage effect. On Sleep-EDF, N3 recall collapses to
