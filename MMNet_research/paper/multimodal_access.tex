...
training seeds and not folds, because that evaluation is a single pass of a finished
checkpoint over all $99$ patients; StagingSeqNet is a single supplied checkpoint and has
none. Sleep-EDF carries no cardiorespiratory channels, so every
