...
sleep as a control on the cohort argument. Dispersion is reported wherever per-fold values
survive: five folds for the earlier retrained baselines, ten for the three reimplemented
...
of each block, Wilcoxon paired on fold-values.}
\label{tab:repr}
\centering
...
respiratory head is not scored there. The ISRUC rows are carried over from the
