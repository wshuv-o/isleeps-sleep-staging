...
than the brain alone. We state the answer here, since it governs how the results should be
...
questions rather than redundant information about one, and the experiments below are designed
to test that separation.
...
is a supporting design choice rather than a primary contribution.
