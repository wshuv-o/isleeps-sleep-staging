...
The margin over the retrained baselines is tested, not eyeballed. The folds are fixed
...
($\mmAcc$ and $\mmAuc$); the shape, not the endpoint, is what it is here to show. Staging is at or near
