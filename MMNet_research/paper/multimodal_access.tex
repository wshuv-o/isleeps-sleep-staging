...
the epoch, so that it tracks the amplitude of the epoch itself rather than a fixed
...
slow-wave amplitude rather than detect discrete waves. Each EOG channel contributes
