...
that the ceiling belongs to the cohort. Cross-validated on
...
burden, and why event-level scoring is the natural next step instead of a
formality.
...
zero-shot, with the montage shift included, the cost is $0.56$. The honest claim is bounded by those two figures together.
