...
frozen pretrained encoder alone      & 0.712 & $-0.028$ & $<0.001$ \\
features $+$ pretrained (proposed)   & \textbf{0.749} & $+0.008$ & $\mathbf{0.001}$ \\
features $+$ two pretrained encoders & 0.745 & $+0.004$ & $0.23$  \\
\bottomrule
\end{tabular}
\end{table}
