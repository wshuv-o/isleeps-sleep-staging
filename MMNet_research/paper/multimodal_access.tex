...
Cells are the mean over thirty fold-values; $p$ is Wilcoxon on the ten fold-means, Holm-corrected across the nine ablations within each metric, and is \textbf{bold} where it clears $0.05$. The floor at this sample size is $0.018$.}
\label{tab:ablate}
\centering
