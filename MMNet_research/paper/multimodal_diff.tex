...
%DIF ADD multimodal.tex   Thu Aug 20 11:06:00 2026
...
\caption{\DIFadd{A representative held-out night (patient SN90, staging accuracy $0.80$).
...
\DIFaddendFL \caption{\DIFdelbeginFL \DIFdelendFL \DIFaddbeginFL Modality-ablation grid. Staging accuracy \DIFaddendFL (\DIFaddbeginFL blue) and respiratory AUC (\DIFaddendFL red) \DIFdelbeginFL \DIFdelendFL \DIFaddbeginFL as each
modality is removed in turn. Removing SpO$_2$ or \DIFaddendFL the \DIFdelbeginFL \DIFdelendFL \DIFaddbeginFL whole cardiorespiratory stream lowers
respiratory \DIFaddendFL AUC \DIFdelbeginFL \DIFdelendFL \DIFaddbeginFL and leaves \DIFaddendFL staging \DIFdelbeginFL \DIFdelendFL \DIFaddbeginFL flat; removing the ocular channel lowers staging\DIFaddendFL .\DIFdelbeginFL \DIFdelendFL }
\DIFdelbeginFL %DIFDELCMD < \label{fig:ablation}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \label{fig:ablationfig}
