...
\subsection{External Validation on an Independent Corpus}
\label{sec:external}
...
Across $11$ recordings and $11{,}272$ epochs the model reaches $0.800$ accuracy, $0.709$
...
\textbf{The model performs better on the cohort it was not trained on.} That inversion is
...
Two qualifications keep this honest. Accuracy across cohorts with different class balance
