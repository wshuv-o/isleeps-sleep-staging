...
polysomnography corpus of subacute ischemic stroke ($100$ patients, $99$ analysed), all under patient-independent ten-fold
...
respiratory events at $\mmAuc$ area under the ROC curve --- an epoch-level, screening-grade
read-out rather than event-by-event scoring --- a capability none of the staging models
possess. The respiratory read-out is grounded in physiology: when we remove the
...
unmeasured. Contribution~C2 benchmarks strong deep architectures on a subacute-stroke cohort and
shows that the healthy-built networks collapse.
